# Generated by Django 5.0.1 on 2024-01-25 06:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', django_resized.forms.ResizedImageField(crop=['middle', 'center'], default='users/default.jpg', force_format='JPEG', keep_meta=True, quality=75, scale=0.5, size=[200, 200], upload_to='users/images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('name', models.CharField(max_length=255)),
                ('image', models.ImageField(default='blog/default.jpg', upload_to='blog/images/')),
